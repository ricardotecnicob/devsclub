...
export default class Rank extends Component {
  ...
  render() {
      const usuariosFiltered = usuarios.filter(usuario => usuario.linguangem === this.state.filter )
    return(
        <div className="areaGeral">
            ...
            <div className="menusAcessos">
                ...
                <div className="areasEmpresas">
                    <Link to="/empresa" className="areaempresas" >Acesso Empresas</Link>
                </div>
            </div>
            ...
            {
                usuariosFiltered.map((user,index) => (
                    <div className="areaClick" key={index} >
                        ...
                        <div className="arealinhaDiv02">
                            <div className="pontuacao">
                                <p className="pontuacaoText">{user.pontuacao}</p> <p className="pontuacaoSub">badges</p> 
                            </div>
                        </div>   
